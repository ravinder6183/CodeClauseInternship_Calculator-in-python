...
label_result=Label(root,width=30,height=3,text="",font=("arial,40"))
label_result.pack()
...
Button(root,text="del",width=5,height=1,font=("arial",30,"bold"),bd=1,fg="#fff",bg="#2a2d36",command=lambda:delete()).place(x=150,y=500)
